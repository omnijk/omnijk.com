...
export default function BasisInfo() {
  return (
    <div className="w-full space-y-4">
      <div className="rounded-lg border border-border/60 bg-background/80 px-4 py-6 shadow-[0_0px_1.2px_rgb(140,140,140)] backdrop-blur-sm transition-all duration-200 hover:-translate-y-1 hover:border-sky-200/70 hover:shadow-lg focus-within:-translate-y-1 focus-within:border-sky-200/70 focus-within:shadow-lg mb-10">
