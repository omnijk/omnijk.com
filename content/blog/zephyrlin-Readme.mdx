---
  title: README-omnijk
  summary: How to create this website? Let's check out Readme for omnijk.com!
...
1. In terminal, run the following command. You can replace "omnijk.com" with another name.
